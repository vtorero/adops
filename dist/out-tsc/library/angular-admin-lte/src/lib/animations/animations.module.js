...
var animations_directive_1 = require("./animations.directive");
var AnimationsModule = /** @class */ (function () {
    function AnimationsModule() {
    }
    AnimationsModule = __decorate([
        core_1.NgModule({
            exports: [animations_directive_1.CollapseAnimationDirective],
            declarations: [animations_directive_1.CollapseAnimationDirective]
        })
    ], AnimationsModule);
